...
class Personnage extends Phaser.Scene {
  ...
  //charge image
  preload() {
    this.load.image('perso', 'http://localhost:80/phaser3/node_modules/phaser3-project-template/assets/profil.png');
    this.load.image('bg', 'http://localhost:80/phaser3/node_modules/phaser3-project-template/assets/bg.png');
  }
