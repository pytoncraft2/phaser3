class Personnage extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('perso', 'http://localhost/phaser3/node_modules/phaser3-project-template/client/src/assets/attackv4.png',{
      frameWidth: 750,
      frameHeight: 1050,
      endFrame: 4
    });
  ...
  // this.image = this.add.image(0,200,'perso');
    ...
    this.fix = this.add.sprite(750,350,"perso");
    this.fix.scale = 0.5;
    this.anims.create({
      key: "perso_anim",
      // frames: this.anims.generateFrameNumbers("perso"),
      frames: this.anims.generateFrameNumbers('perso',{ }),
      // frames: this.anims.generateFrameNumbers('perso',{ start: 0, end: 6, first:1 }),
      frameRate: 7,
      repeat: 0
      // timeScale: 2
      // yoyo: true
  ...
  update(delta) {
    ...
    // this.fix.anims.setCurrentFrame(this.fix.anims.frames[1]);
