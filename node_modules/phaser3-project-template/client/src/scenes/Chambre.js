class Chambre extends Phaser.Scene {
  ...
  create() {
    ...
    this.socket.on('premierJ', function () {
      ...
      self.text = self.add.text(10,10, "Premier joueur !", {font: "35px Impact"})
    },this)
    ...
    this.input.keyboard.on('keyup_A', function(e) {
      ...
      this.socket.emit('initializeplayer', this.gamename)
  ...
  update(delta) {
    ...
    //bigger
    // console.log(this.fix.x);
    // console.log(this.fix.scale);
