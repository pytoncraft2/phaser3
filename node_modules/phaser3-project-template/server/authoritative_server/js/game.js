...
function update() {
  this.players.getChildren().forEach((player) => {
    ...
    // console.log(players[player.playerId].anim);
...
function addPlayer(self, playerInfo) {
  const player = self.physics.add.sprite(playerInfo.x, playerInfo.y, 'atlas', 'profil2').setScale(0.38).setOrigin(0.5)/*.setDisplaySize(136, 392)*/;
