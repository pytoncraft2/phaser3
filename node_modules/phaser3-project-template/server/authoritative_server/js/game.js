...
function update() {
  this.players.getChildren().forEach((player) => {
    ...
    input.left ? (player.setVelocityX(-300) , player.flipX = false)
    : input.right ? (player.setVelocityX(300) , player.flipX = true)
    : player.setVelocityX(0)
/*
    input.up ? player.scale -= .2
    : input.down ? player.scale += .2
...
*/
    ...
    // .setOrigin(0.5, 0.5).setDisplaySize(368, 496);
