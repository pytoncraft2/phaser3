    ...
    Object.keys(players).forEach(function (id) {
      self.players.getChildren().forEach(function (player) {
        if (players[id].playerId === player.playerId) {
          ...
          // var animation = players[id].anims;
          // player.play(animation);
          // player.play(''+players[id].anims+'',false);
          player.play('perso_anim',true);
          // console.log(players[id].anims);
          // player.activeAnim(players[id].anims);
