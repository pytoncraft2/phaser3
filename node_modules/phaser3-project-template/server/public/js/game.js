...
function preload() {
  ...
  this.load.atlas('perso', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/kkk.png', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/sprites.json');
  ...
  /*
  this.load.spritesheet('perso', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/kicksAttackAutre.png', {
    frameWidth: 752.5,
    frameHeight: 1050,
    endFrame: 6
  });
...
*/
  ...
  // this.tests = this.add.sprite(100,400,"perso","positionk3");
  // this.tests.scale = 0.4;
  /*
  this.anims.create({
    key: "perso_anim",
