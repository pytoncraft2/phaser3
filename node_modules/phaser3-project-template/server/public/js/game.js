...
function preload() {
  ...
  this.load.spritesheet('autres', 'http://localhost/phaser3/node_modules/phaser3-project-template/client/src/assets/kicksAttackAutre.png', {
    frameWidth: 752.5,
    frameHeight: 1050,
    endFrame: 4
  });
...
function create() {
  ...
  // this.perso = this.add.sprite(750, 447, "perso");
  // this.fix.scale = 0.30;
  this.anims.create({
    key: "perso_anim",
  ...
  this.redScoreText = this.add.text(1340, 16, '', { fontSize: '32px', fill: '#FF0000' });

  this.socket.on('currentPlayers', function (players) {
    Object.keys(players).forEach(function (id) {
      if (players[id].playerId === self.socket.id) {
        displayPlayers(self, players[id], 'perso');
      } else {
...
function displayPlayers(self, playerInfo, sprite) {
  const player = self.add.sprite(playerInfo.x, playerInfo.y, sprite).setOrigin(0.5, 0.5).setDisplaySize(368, 496);
