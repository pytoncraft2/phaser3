...
function preload() {
  ...
  this.load.image('bg', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/fond/bg.png');
...
function create() {
  ...
  this.anims.create({
    key: "goback",
    frames: this.anims.generateFrameNumbers('atlas', {frames: ['dos5','dos7.8','dos8','dos9','dos10.1','dos11','dos3']}),
    frameRate: 7,
    repeat: 0
  });
