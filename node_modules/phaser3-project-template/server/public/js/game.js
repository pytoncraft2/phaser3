...
function preload() {
  ...
  this.load.atlas('positions', ' http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/final.png', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/final.json');
...
function create() {
  ...
  this.anims.create({
    key: 'front',
    frames: this.anims.generateFrameNames('position', {
      prefix: 'face1.png',
      end: 32,
      zeroPad: 4
    }),
  ...
  /*
    ...
    this.anims.create({
    key: "front",
    frames: this.anims.generateFrameNumbers('face', {frames: [0,1,2,3,0]}),
    frameRate: 6,
    repeat: 0
  });
