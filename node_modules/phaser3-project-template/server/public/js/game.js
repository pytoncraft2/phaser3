...
function preload() {
  ...
  this.load.atlas('atlas', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/resized/deplacement/deuxrow.png', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/resized/deplacement/deuxrow_atlas.json');
...
function create() {
  ...
  var self = this;
    ...
    this.anims.create({
    key: "attack1",
    frames: this.anims.generateFrameNumbers('atlas', {frames: ['profil2']}),
    frameRate: 6,
    repeat: 0
  });
  ...
  this.anims.create({
    key: "goback",
    frames: this.anims.generateFrameNumbers('atlas', {frames: ['dos']}),
    frameRate: 7,
    repeat: 0
  });
    ...
    this.anims.create({
    key: "walk",
    frames: this.anims.generateFrameNumbers('atlas', {frames: ['profil_jkd11','profil_jkd13','profil_jkd15','profil_jkd14','profil_jkd8']}),
    frameRate: 5,
    repeat: 0
  });
