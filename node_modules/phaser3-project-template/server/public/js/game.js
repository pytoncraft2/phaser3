...
function preload() {
  ...
  this.load.atlas('tests', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/kkk.png', 'http://localhost/phaser3/node_modules/phaser3-project-template/server/authoritative_server/assets/tests/sprites.json');
...
function create() {
  ...
  this.tests = this.add.sprite(100,400,"tests","positionk3");
