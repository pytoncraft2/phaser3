...
io.on('connection', function(socket) {
  ...
  if (players.length === 1) io.emit('premierJ');
...
socket.on('keyrelease', (action,commandes) => {
// console.log('clé pressé:' + touche + " joueur: " +joueur);
// console.log("touche - ");
console.log(action,commandes);
});


socket.on('keypress', (action,commandes) => {
// console.log('clé pressé:' + touche + " joueur: " +joueur);
// console.log("touche + ");
console.log(action,commandes);
});
